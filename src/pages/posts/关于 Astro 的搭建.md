...
部署完成:
![部署完成](/images/2024-12-08/Cloudflare.png "部署完成")
...
3. 填入已经在 Cloudflare 中托管的域名，点击继续。
  ![自定义域1](/images/2024-12-08/zdyy1.png "自定义域1")
4. 确认 DNS 记录值，点击 激活域 。Cloudflare 会帮我们自动解析 DNS.
  ![自定义域2](/images/2024-12-08/zdyy2.png "自定义域2")
5. 添加成功，显示正在验证。
  ![自定义域3](/images/2024-12-08/zdyy3.png "自定义域3")
6. 等待几分钟，访问域名就好了。
